...
#if M_MIL_USE_RT
#ifdef M_BEAD_EXPORTS
#define MIL_BEAD_DLLFUNC __declspec(dllexport)
#else
#define MIL_BEAD_DLLFUNC __declspec(dllimport)
#endif
#else
#define MIL_BEAD_DLLFUNC
#endif
...
#define M_TEMPLATE_INDEX(i)                  (M_TEMPLATE_INDEX_TAG   | (i))
   ...
   MIL_BEAD_DLLFUNC void MFTYPE MbeadControlInt64(MIL_ID     ContextBeadId,
                                 MIL_INT    LabelOrIndex,
                                 MIL_INT64  ControlType,
                                 MIL_INT64  ControlValue);

   MIL_BEAD_DLLFUNC void MFTYPE MbeadControlDouble(MIL_ID     ContextBeadId,
                                  MIL_INT    LabelOrIndex,
                                  MIL_INT64  ControlType,
...
#define MbeadControlDouble MbeadControl
   ...
   MIL_BEAD_DLLFUNC void MFTYPE MbeadControl(MIL_ID     ContextBeadId,
                            MIL_INT    LabelOrIndex,
                            MIL_INT64  ControlType,
                            MIL_DOUBLE ControlValue);
#endif

   MIL_BEAD_DLLFUNC MIL_ID   MFTYPE  MbeadAlloc(MIL_ID     SysId,
                               MIL_INT64  Strategy,
                               MIL_INT64  ControlFlag,
                               MIL_ID*    ContextBeadIdPtr);

   MIL_BEAD_DLLFUNC MIL_ID   MFTYPE  MbeadAllocResult(MIL_ID     SysId,
                                     MIL_INT64  ControlFlag,
                                     MIL_ID*    ResultBeadIdPtr);

   MIL_BEAD_DLLFUNC void     MFTYPE  MbeadFree(MIL_ID   ContextOrResultBeadId);


   MIL_BEAD_DLLFUNC MIL_INT  MFTYPE  MbeadInquire(MIL_ID     ContextOrResultBeadId,
                                 MIL_INT    LabelOrIndex,
                                 MIL_INT64  InquireType,
                                 void*      UserVarPtr);

   MIL_BEAD_DLLFUNC void     MFTYPE  MbeadTemplate(MIL_ID            ContextBeadId,
                                  MIL_INT64         Operation,
                                  MIL_INT64         BeadType,
                                  MIL_INT           LabelOrIndex,
   ...
   MIL_BEAD_DLLFUNC void     MFTYPE  MbeadTrain(MIL_ID     ContextBeadId,
                               MIL_ID     TrainingImageBufId,
                               MIL_INT64  ControlFlag);

   MIL_BEAD_DLLFUNC void     MFTYPE  MbeadVerify(MIL_ID     ContextBeadId,
                                MIL_ID     TargetImageBufId,
                                MIL_ID     ResultBeadId,
                                MIL_INT64  ControlFlag);

   MIL_BEAD_DLLFUNC void     MFTYPE  MbeadGetResult(MIL_ID       ResultBeadId,
                                   MIL_INT      LabelOrIndex,
                                   MIL_INT      ResultIndex,
                                   MIL_INT64    ResultType,
                                   void*        UserVarPtr);

   MIL_BEAD_DLLFUNC void     MFTYPE   MbeadGetNeighbors(MIL_ID     ContextBeadId,
                                       MIL_INT    LabelOrIndex,
   ...
   MIL_BEAD_DLLFUNC void     MFTYPE  MbeadDraw(MIL_ID      ContextGraId,
   ...
   MIL_BEAD_DLLFUNC MIL_ID MFTYPE MbeadRestoreW(MIL_CONST_TEXTW_PTR FileName,
                               MIL_ID     SysId,
                               MIL_INT64  ControlFlag,
                               MIL_ID*    ContextBeadIdPtr);

   MIL_BEAD_DLLFUNC void MFTYPE MbeadSaveW(MIL_CONST_TEXTW_PTR FileName,
                          MIL_ID     ContextBeadId,
                          MIL_INT64  ControlFlag);

   MIL_BEAD_DLLFUNC void MFTYPE MbeadStreamW(MIL_TEXTW_PTR MemPtrOrFileName,
                            MIL_ID     SysId,
                            MIL_INT64  Operation,
   ...
   MIL_BEAD_DLLFUNC MIL_ID MFTYPE MbeadRestoreA(MIL_CONST_TEXTA_PTR FileName,
                               MIL_ID      SysId,
                               MIL_INT64   ControlFlag,
                               MIL_ID*     ContextBeadIdPtr);

   MIL_BEAD_DLLFUNC void MFTYPE MbeadSaveA(MIL_CONST_TEXTA_PTR FileName,
                          MIL_ID      ContextBeadId,
                          MIL_INT64   ControlFlag);

   MIL_BEAD_DLLFUNC void MFTYPE MbeadStreamA(MIL_TEXTA_PTR      MemPtrOrFileName,
                            MIL_ID     SysId,
                            MIL_INT64  Operation,
                            MIL_INT64  StreamType,
                            MIL_DOUBLE Version,
...
#define MbeadStream         MbeadStreamA
   ...
   MIL_BEAD_DLLFUNC MIL_ID MFTYPE MbeadRestore(MIL_CONST_TEXT_PTR FileName,
                              MIL_ID             SysId,
                              MIL_INT64          ControlFlag,
                              MIL_ID*            ContextBeadIdPtr);

   MIL_BEAD_DLLFUNC void MFTYPE MbeadSave(MIL_CONST_TEXT_PTR FileName,
                         MIL_ID             ContextBeadId,
                         MIL_INT64          ControlFlag);

   MIL_BEAD_DLLFUNC void MFTYPE MbeadStream(MIL_TEXT_PTR MemPtrOrFileName,
                           MIL_ID       SysId,
                           MIL_INT64    Operation,
                           MIL_INT64    StreamType,
                           MIL_DOUBLE   Version,
...
inline void MFTYPE MbeadGetResultUnsafe  (MIL_ID ResultBeadId, MIL_INT LabelOrIndex, MIL_INT ResultIndex, MIL_INT64 ResultType, void           *UserVarPtr);
inline void MFTYPE MbeadGetResultSafeType(MIL_ID ResultBeadId, MIL_INT LabelOrIndex, MIL_INT ResultIndex, MIL_INT64 ResultType, int             UserVarPtr);
#if M_MIL_SAFE_TYPE_M_NULL_PTR_TYPE_EXISTS
inline void MFTYPE MbeadGetResultSafeType(MIL_ID ResultBeadId, MIL_INT LabelOrIndex, MIL_INT ResultIndex, MIL_INT64 ResultType, std::nullptr_t            );
#endif
inline void MFTYPE MbeadGetResultSafeType(MIL_ID ResultBeadId, MIL_INT LabelOrIndex, MIL_INT ResultIndex, MIL_INT64 ResultType, MIL_INT32      *UserVarPtr);
inline void MFTYPE MbeadGetResultSafeType(MIL_ID ResultBeadId, MIL_INT LabelOrIndex, MIL_INT ResultIndex, MIL_INT64 ResultType, MIL_INT64      *UserVarPtr);
inline void MFTYPE MbeadGetResultSafeType(MIL_ID ResultBeadId, MIL_INT LabelOrIndex, MIL_INT ResultIndex, MIL_INT64 ResultType, MIL_DOUBLE     *UserVarPtr);
#if M_MIL_SAFE_TYPE_SUPPORTS_UNSIGNED                                    
inline void MFTYPE MbeadGetResultSafeType(MIL_ID ResultBeadId, MIL_INT LabelOrIndex, MIL_INT ResultIndex, MIL_INT64 ResultType, MIL_UINT32     *UserVarPtr);
inline void MFTYPE MbeadGetResultSafeType(MIL_ID ResultBeadId, MIL_INT LabelOrIndex, MIL_INT ResultIndex, MIL_INT64 ResultType, MIL_UINT64     *UserVarPtr);
#endif
...
inline MIL_INT MFTYPE MbeadInquireSafeType(MIL_ID ContextOrResultBeadId, MIL_INT LabelOrIndex, MIL_INT64 InquireType, MIL_INT32      *UserVarPtr);
inline MIL_INT MFTYPE MbeadInquireSafeType(MIL_ID ContextOrResultBeadId, MIL_INT LabelOrIndex, MIL_INT64 InquireType, MIL_INT64      *UserVarPtr);
inline MIL_INT MFTYPE MbeadInquireSafeType(MIL_ID ContextOrResultBeadId, MIL_INT LabelOrIndex, MIL_INT64 InquireType, MIL_DOUBLE     *UserVarPtr);
inline MIL_INT MFTYPE MbeadInquireSafeType(MIL_ID ContextOrResultBeadId, MIL_INT LabelOrIndex, MIL_INT64 InquireType, int             UserVarPtr);
#if M_MIL_SAFE_TYPE_M_NULL_PTR_TYPE_EXISTS
inline MIL_INT MFTYPE MbeadInquireSafeType(MIL_ID ContextOrResultBeadId, MIL_INT LabelOrIndex, MIL_INT64 InquireType, std::nullptr_t            );
#endif
#if M_MIL_SAFE_TYPE_SUPPORTS_UNSIGNED                                      
inline MIL_INT MFTYPE MbeadInquireSafeType(MIL_ID ContextOrResultBeadId, MIL_INT LabelOrIndex, MIL_INT64 InquireType, MIL_UINT32     *UserVarPtr);
inline MIL_INT MFTYPE MbeadInquireSafeType(MIL_ID ContextOrResultBeadId, MIL_INT LabelOrIndex, MIL_INT64 InquireType, MIL_UINT64     *UserVarPtr);
#endif

// -------------------------------------------------------------------------
// MbeadGetResult

inline void MFTYPE MbeadGetResultSafeType (MIL_ID ResultBeadId, MIL_INT LabelOrIndex, MIL_INT ResultIndex, MIL_INT64 ResultType, int ResultPtr)
   {
   if (ResultPtr)
      SafeTypeError(MIL_TEXT("MmbeadGetResult"));

   MbeadGetResult(ResultBeadId, LabelOrIndex, ResultIndex, ResultType, NULL);
   }
...
inline void MbeadGetResultSafeTypeExecute (MIL_ID ResultBeadId, MIL_INT LabelOrIndex, MIL_INT ResultIndex, MIL_INT64 ResultType, void *ResultArrayPtr, MIL_INT64  GivenType)
   {
...
inline void MFTYPE MbeadGetResultUnsafe  (MIL_ID ResultBeadId, MIL_INT LabelOrIndex, MIL_INT ResultIndex, MIL_INT64 ResultType, void        *ResultArrayPtr){MbeadGetResult               (ResultBeadId, LabelOrIndex, ResultIndex, ResultType, ResultArrayPtr);}
inline void MFTYPE MbeadGetResultSafeType(MIL_ID ResultBeadId, MIL_INT LabelOrIndex, MIL_INT ResultIndex, MIL_INT64 ResultType, MIL_INT32   *ResultArrayPtr){MbeadGetResultSafeTypeExecute(ResultBeadId, LabelOrIndex, ResultIndex, ResultType, ResultArrayPtr, M_TYPE_MIL_INT32);}
inline void MFTYPE MbeadGetResultSafeType(MIL_ID ResultBeadId, MIL_INT LabelOrIndex, MIL_INT ResultIndex, MIL_INT64 ResultType, MIL_INT64   *ResultArrayPtr){MbeadGetResultSafeTypeExecute(ResultBeadId, LabelOrIndex, ResultIndex, ResultType, ResultArrayPtr, M_TYPE_MIL_INT64);}
inline void MFTYPE MbeadGetResultSafeType(MIL_ID ResultBeadId, MIL_INT LabelOrIndex, MIL_INT ResultIndex, MIL_INT64 ResultType, MIL_DOUBLE  *ResultArrayPtr){MbeadGetResultSafeTypeExecute(ResultBeadId, LabelOrIndex, ResultIndex, ResultType, ResultArrayPtr, M_TYPE_DOUBLE);}
#if M_MIL_SAFE_TYPE_SUPPORTS_UNSIGNED                                    
inline void MFTYPE MbeadGetResultSafeType(MIL_ID ResultBeadId, MIL_INT LabelOrIndex, MIL_INT ResultIndex, MIL_INT64 ResultType, MIL_UINT32  *ResultArrayPtr){MbeadGetResultSafeTypeExecute(ResultBeadId, LabelOrIndex, ResultIndex, ResultType, ResultArrayPtr, M_TYPE_MIL_INT32);}
inline void MFTYPE MbeadGetResultSafeType(MIL_ID ResultBeadId, MIL_INT LabelOrIndex, MIL_INT ResultIndex, MIL_INT64 ResultType, MIL_UINT64  *ResultArrayPtr){MbeadGetResultSafeTypeExecute(ResultBeadId, LabelOrIndex, ResultIndex, ResultType, ResultArrayPtr, M_TYPE_MIL_INT64);}
#endif
...
inline MIL_INT MFTYPE MbeadInquireSafeType  (MIL_ID ContextOrResultBeadId, MIL_INT LabelOrIndex, MIL_INT64 InquireType, int UserVarPtr )
   ...
   return MbeadInquire(ContextOrResultBeadId, LabelOrIndex, InquireType, NULL);
   }
...
inline MIL_INT MFTYPE MbeadInquireSafeTypeExecute (MIL_ID ContextOrResultBeadId, MIL_INT LabelOrIndex, MIL_INT64 InquireType, void *UserVarPtr, MIL_INT64 GivenType)
   {
...
inline MIL_INT MFTYPE MbeadInquireUnsafe  (MIL_ID ContextOrResultBeadId, MIL_INT LabelOrIndex, MIL_INT64 InquireType, void       *UserVarPtr) {return MbeadInquire               (ContextOrResultBeadId, LabelOrIndex, InquireType, UserVarPtr                  );}
inline MIL_INT MFTYPE MbeadInquireSafeType(MIL_ID ContextOrResultBeadId, MIL_INT LabelOrIndex, MIL_INT64 InquireType, MIL_INT32  *UserVarPtr) {return MbeadInquireSafeTypeExecute(ContextOrResultBeadId, LabelOrIndex, InquireType, UserVarPtr, M_TYPE_MIL_INT32);}
inline MIL_INT MFTYPE MbeadInquireSafeType(MIL_ID ContextOrResultBeadId, MIL_INT LabelOrIndex, MIL_INT64 InquireType, MIL_INT64  *UserVarPtr) {return MbeadInquireSafeTypeExecute(ContextOrResultBeadId, LabelOrIndex, InquireType, UserVarPtr, M_TYPE_MIL_INT64);}
inline MIL_INT MFTYPE MbeadInquireSafeType(MIL_ID ContextOrResultBeadId, MIL_INT LabelOrIndex, MIL_INT64 InquireType, MIL_DOUBLE *UserVarPtr) {return MbeadInquireSafeTypeExecute(ContextOrResultBeadId, LabelOrIndex, InquireType, UserVarPtr, M_TYPE_DOUBLE   );}
#if M_MIL_SAFE_TYPE_SUPPORTS_UNSIGNED                                                                                                                                                
inline MIL_INT MFTYPE MbeadInquireSafeType(MIL_ID ContextOrResultBeadId, MIL_INT LabelOrIndex, MIL_INT64 InquireType, MIL_UINT32 *UserVarPtr) {return MbeadInquireSafeTypeExecute(ContextOrResultBeadId, LabelOrIndex, InquireType, UserVarPtr, M_TYPE_MIL_INT32);}
inline MIL_INT MFTYPE MbeadInquireSafeType(MIL_ID ContextOrResultBeadId, MIL_INT LabelOrIndex, MIL_INT64 InquireType, MIL_UINT64 *UserVarPtr) {return MbeadInquireSafeTypeExecute(ContextOrResultBeadId, LabelOrIndex, InquireType, UserVarPtr, M_TYPE_MIL_INT64);}
#endif
