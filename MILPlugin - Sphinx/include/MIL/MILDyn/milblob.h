...
#define M_CONTIGUOUS_LABELS                           2713L
...
MIL_BLOB_DLLFUNC void    MFTYPE MblobTransform(       MIL_ID     SrcResultBlobId,
                                                      MIL_ID     DstResultBlobId,
                                                      MIL_INT64  Operation,
...
MIL_BLOB_DLLFUNC void    MFTYPE MblobSaveA(           MIL_CONST_TEXTA_PTR        FileName,
                                                      MIL_ID             ContextBlobId,
                                                      MIL_INT64          ControlFlag);

MIL_BLOB_DLLFUNC MIL_ID  MFTYPE MblobRestoreA(        MIL_CONST_TEXTA_PTR        FileName,
                                                      MIL_ID             SysId,
                                                      MIL_INT64          ControlFlag,
                                                      MIL_ID*            ContextBlobIdPtr);

MIL_BLOB_DLLFUNC void    MFTYPE MblobStreamA(         MIL_TEXTA_PTR      MemPtrOrFileName,
                                                      MIL_ID             SysId,
                                                      MIL_INT64          Operation,
...
MIL_BLOB_DLLFUNC void    MFTYPE MblobSaveW(           MIL_CONST_TEXTW_PTR FileName,
                                                      MIL_ID             ContextBlobId,
                                                      MIL_INT64          ControlFlag);

MIL_BLOB_DLLFUNC MIL_ID  MFTYPE MblobRestoreW(        MIL_CONST_TEXTW_PTR FileName,
                                                      MIL_ID             SysId,
                                                      MIL_INT64          ControlFlag,
                                                      MIL_ID*            ContextBlobIdPtr);

MIL_BLOB_DLLFUNC void    MFTYPE MblobStreamW(         MIL_TEXTW_PTR       MemPtrOrFileName,
                                                      MIL_ID             SysId,
                                                      MIL_INT64          Operation,
                                                      MIL_INT64          StreamType,
                                                      MIL_DOUBLE         Version,
...
inline void MFTYPE MblobGetResultSafeType(MIL_ID ResultBlobId, MIL_INT LabelOrIndex, MIL_INT64 ResultType, std::nullptr_t            );
#endif
...
#if M_MIL_SAFE_TYPE_M_NULL_PTR_TYPE_EXISTS
inline void MFTYPE MblobGetResultSafeType(MIL_ID ResultBlobId, MIL_INT64 ResultType, std::nullptr_t            ) { MblobGetResultSafeType(ResultBlobId, M_DEFAULT, ResultType, M_NULL        ); }
#endif
...
#if M_MIL_SAFE_TYPE_M_NULL_PTR_TYPE_EXISTS
inline MIL_INT MFTYPE MblobInquireSafeType(MIL_ID ResOrFeatListBlobId, MIL_INT64  InquireType, std::nullptr_t        );
#endif
