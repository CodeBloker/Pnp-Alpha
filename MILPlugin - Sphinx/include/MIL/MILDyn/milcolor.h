...
#if M_MIL_USE_RT
#ifdef M_COLOR_EXPORTS
#define MIL_COLOR_DLLFUNC __declspec(dllexport)
#else
#define MIL_COLOR_DLLFUNC __declspec(dllimport)
#endif
#else
#define MIL_COLOR_DLLFUNC
#endif
...
MIL_COLOR_DLLFUNC MIL_ID MFTYPE McolAlloc(MIL_ID      SystemId,
...
MIL_COLOR_DLLFUNC MIL_ID MFTYPE McolAllocResult(MIL_ID     SystemId, 
                              MIL_INT64  ResultType, 
                              MIL_INT64  ControlFlag, 
                              MIL_ID*    ResultIdPtr);

MIL_COLOR_DLLFUNC void   MFTYPE McolDefine(MIL_ID     ContextId,
...
MIL_COLOR_DLLFUNC void MFTYPE McolPreprocess(MIL_ID      ContextId,
                           MIL_INT64   ControlFlag);

MIL_COLOR_DLLFUNC void MFTYPE McolMatch(MIL_ID     ContextId,
...
MIL_COLOR_DLLFUNC void MFTYPE McolFree(MIL_ID ContextIdOrResultId);

MIL_COLOR_DLLFUNC MIL_INT MFTYPE McolInquire(MIL_ID     ContextOrResultId,
                           MIL_INT    IndexOrLabel,
                           MIL_INT64  InquireType,
                           void      *UserVarPtr);

MIL_COLOR_DLLFUNC void MFTYPE McolGetResult(MIL_ID     ResultId,
                          MIL_INT    AreaLabel,
                          MIL_INT    ColorSampleIndexOrLabel,
                          MIL_INT64  ResultType,
                          void      *ResultArrayPtr);

MIL_COLOR_DLLFUNC void MFTYPE McolDistance(MIL_ID     Src1Id,
                         MIL_ID     Src2Id,
                         MIL_ID     DestId,
                         MIL_ID     MaskId,
...
MIL_COLOR_DLLFUNC void MFTYPE McolDraw(MIL_ID     GraphContId,
...
MIL_COLOR_DLLFUNC void MFTYPE McolMask(MIL_ID     ContextId,
                     MIL_INT    ColorSampleIndexOrLabel,
                     MIL_ID     MaskBufferId,
                     MIL_INT64  MaskType,
                     MIL_INT64  ControlFlag);

MIL_COLOR_DLLFUNC void MFTYPE McolSetMethod(MIL_ID     ContextId,
                          MIL_INT64  OperationMode,
                          MIL_INT64  DistTypeOrCalIntent,
                          MIL_INT64  ConversionModeOrComputeOption,
                          MIL_INT64  ControlFlag);

MIL_COLOR_DLLFUNC void MFTYPE McolProject(MIL_ID      Src1ImageId,
...
MIL_COLOR_DLLFUNC void MFTYPE McolTransform(MIL_ID    ContextId,
                                            MIL_INT   SampleIndexOrLabel,
                                            MIL_ID    SrcImageBufId,
                                            MIL_ID    DestImageBufId,
                                            MIL_INT64 ControlFlag); 
...
MIL_COLOR_DLLFUNC void MFTYPE McolControlInt64    (MIL_ID      ContextId,
                                 MIL_INT     IndexOrLabel,
                                 MIL_INT64   ControlType,
                                 MIL_INT64   ControlValue);

MIL_COLOR_DLLFUNC void MFTYPE McolControlDouble   (MIL_ID      ContextId,
                                 MIL_INT     IndexOrLabel,
                                 MIL_INT64   ControlType,
...
MIL_COLOR_DLLFUNC void MFTYPE McolControl         (MIL_ID      ContextId,
                                 MIL_INT     IndexOrLabel,
                                 MIL_INT64   ControlType,
                                 MIL_DOUBLE  ControlValue);
#endif
...
MIL_COLOR_DLLFUNC MIL_ID MFTYPE McolRestoreW(MIL_CONST_TEXTW_PTR FileName,
                           MIL_ID SystemId,
                           MIL_INT64  ControlFlag,
                           MIL_ID *ContextIdPtr);

MIL_COLOR_DLLFUNC void MFTYPE McolSaveW(MIL_CONST_TEXTW_PTR FileName,
                      MIL_ID ContextId,
                      MIL_INT64  ControlFlag);

MIL_COLOR_DLLFUNC void MFTYPE McolStreamW(MIL_TEXTW_PTR   MemPtrOrFileName,
                        MIL_ID         SysId,
                        MIL_INT64      Operation,
...
MIL_COLOR_DLLFUNC MIL_ID MFTYPE McolRestoreA(MIL_CONST_TEXTA_PTR FileName,
                           MIL_ID      SystemId,
                           MIL_INT64   ControlFlag,
                           MIL_ID*     ContextIdPtr);

MIL_COLOR_DLLFUNC void MFTYPE McolSaveA(MIL_CONST_TEXTA_PTR FileName,
                      MIL_ID      ContextId,
                      MIL_INT64   ControlFlag);

MIL_COLOR_DLLFUNC void MFTYPE McolStreamA(MIL_TEXTA_PTR      MemPtrOrFileName,
                        MIL_ID     SysId,
                        MIL_INT64  Operation,
                        MIL_INT64  StreamType,
                        MIL_DOUBLE Version,
...
MIL_COLOR_DLLFUNC MIL_ID MFTYPE McolRestore(MIL_CONST_TEXT_PTR FileName,
                          MIL_ID SystemId,
                          MIL_INT64  ControlFlag,
                          MIL_ID *ContextIdPtr);

MIL_COLOR_DLLFUNC void MFTYPE McolSave(MIL_CONST_TEXT_PTR FileName,
                     MIL_ID ContextId,
                     MIL_INT64  ControlFlag);

MIL_COLOR_DLLFUNC void MFTYPE McolStream(MIL_TEXT_PTR MemPtrOrFileName,
                       MIL_ID       SysId,
                       MIL_INT64    Operation,
                       MIL_INT64    StreamType,
                       MIL_DOUBLE   Version,
...
#define McolControl  McolControlDouble
   ...
   inline void MFTYPE McolGetResultSafeType(MIL_ID ResultId, MIL_INT AreaLabel, MIL_INT ColorSampleIndexOrLabel, MIL_INT64  ResultType, std::nullptr_t)
      {
      McolGetResult(ResultId, AreaLabel, ColorSampleIndexOrLabel, ResultType, NULL);
      }
#endif
...
#if M_MIL_SAFE_TYPE_M_NULL_PTR_TYPE_EXISTS
   inline MIL_INT MFTYPE McolInquireSafeType(MIL_ID ContextId, MIL_INT IndexOrLabel, MIL_INT64  InquireType, std::nullptr_t)
      {
      return McolInquire(ContextId, IndexOrLabel, InquireType, NULL);
      }
#endif
...
inline MIL_ID MFTYPE McolRestoreW(const MIL_STRING& FileName, MIL_ID SystemId, MIL_INT64 ControlFlag, MIL_ID* ContextIdPtr)
   {
   return McolRestoreW(FileName.c_str(), SystemId, ControlFlag, ContextIdPtr);
   }
...
inline MIL_ID MFTYPE McolRestoreA(const MIL_STRING& FileName, MIL_ID SystemId, MIL_INT64 ControlFlag, MIL_ID* ContextIdPtr)
   {
   return McolRestoreA(FileName.c_str(), SystemId, ControlFlag, ContextIdPtr);
   }
...
inline MIL_ID MFTYPE McolRestore(const MIL_STRING& FileName, MIL_ID SystemId, MIL_INT64 ControlFlag, MIL_ID* ContextIdPtr)
   {
   return McolRestore(FileName.c_str(), SystemId, ControlFlag, ContextIdPtr);
   }
...
inline MIL_UNIQUE_COL_ID McolAlloc(MIL_ID SystemId, MIL_INT64 ContextType, MIL_INT64 SourceColorSpace, MIL_ID ColorSpaceProfileId, MIL_INT64 ControlFlag, MIL_UNIQUE_ID_TAG)
   {
   return MIL_UNIQUE_COL_ID(McolAlloc(SystemId, ContextType, SourceColorSpace, ColorSpaceProfileId, ControlFlag, M_NULL));
   }
inline MIL_UNIQUE_COL_ID McolAllocResult(MIL_ID SystemId, MIL_INT64 ResultType, MIL_INT64 ControlFlag, MIL_UNIQUE_ID_TAG)
   {
   return MIL_UNIQUE_COL_ID(McolAllocResult(SystemId, ResultType, ControlFlag, M_NULL));
   }
inline MIL_UNIQUE_COL_ID McolRestore(MIL_CONST_TEXT_PTR FileName, MIL_ID SystemId, MIL_INT64 ControlFlag, MIL_UNIQUE_ID_TAG)
   {
   return MIL_UNIQUE_COL_ID(McolRestore(FileName, SystemId, ControlFlag, M_NULL));
   }
#if M_MIL_USE_STRING
inline MIL_UNIQUE_COL_ID McolRestore(const MIL_STRING& FileName, MIL_ID SystemId, MIL_INT64 ControlFlag, MIL_UNIQUE_ID_TAG)
   {
   return MIL_UNIQUE_COL_ID(McolRestore(FileName, SystemId, ControlFlag, M_NULL));
   }
#endif // M_MIL_USE_STRING
