...
#if M_MIL_USE_RT
#ifdef M_REG_EXPORTS
#define MIL_REG_DLLFUNC __declspec(dllexport)
#else
#define MIL_REG_DLLFUNC __declspec(dllimport)
#endif
#else
#define MIL_REG_DLLFUNC
#endif
...
#define M_HDR_SUCCESSFULL                        0L
#define M_HDR_INSUFFICIENT_COLOR_DEPTH           1L
...
MIL_REG_DLLFUNC MIL_ID MFTYPE MregAlloc(MIL_ID SystemId,
                        MIL_INT64  RegistrationType,
                        MIL_INT64  ControlFlag,
                        MIL_ID *ContextIdPtr);

MIL_REG_DLLFUNC MIL_ID MFTYPE MregAllocResult(MIL_ID SystemId,
                              MIL_INT64  ControlFlag,
                              MIL_ID *ResultIdPtr);

MIL_REG_DLLFUNC void MFTYPE MregCalculate(MIL_ID ContextId,
...
MIL_REG_DLLFUNC void MFTYPE MregControlInt64 (MIL_ID ContextOrResultId,
                              MIL_INT Index,
                              MIL_INT64  ControlType,
                              MIL_INT64  ControlValue);

MIL_REG_DLLFUNC void MFTYPE MregControlDouble(MIL_ID     ContextOrResultId,
                              MIL_INT    Index,
                              MIL_INT64  ControlType,
...
MIL_REG_DLLFUNC void MFTYPE MregControl      (MIL_ID     ContextOrResultId,
                              MIL_INT    Index,
                              MIL_INT64  ControlType,
                              MIL_DOUBLE ControlValue);
#endif

MIL_REG_DLLFUNC void MFTYPE MregDraw(MIL_ID ContextGraId,
                     MIL_ID ResultRegId,
...
MIL_REG_DLLFUNC void MFTYPE MregFree(MIL_ID ContextOrResultId);

MIL_REG_DLLFUNC void MFTYPE MregGetResult(MIL_ID RegResultId,
                          MIL_INT    ResultIndex,
                          MIL_INT64  ResultType,
                          void *ResultArrayPtr);

MIL_REG_DLLFUNC MIL_INT MFTYPE MregInquire(MIL_ID ContextOrResultId,
                           MIL_INT Index,
...
MIL_REG_DLLFUNC MIL_ID MFTYPE MregRestoreW(MIL_CONST_TEXTW_PTR FileName,
                           MIL_ID SystemId,
                           MIL_INT64  ControlFlag,
                           MIL_ID *ContextOrResultIdPtr);

MIL_REG_DLLFUNC void MFTYPE MregSaveW(MIL_CONST_TEXTW_PTR FileName,
                      MIL_ID ContextOrResultId,
                      MIL_INT64  ControlFlag);

MIL_REG_DLLFUNC void MFTYPE MregStreamW(MIL_TEXTW_PTR MemPtrOrFileName,
                        MIL_ID SysId,
                        MIL_INT64  Operation,
...
MIL_REG_DLLFUNC MIL_ID MFTYPE MregRestoreA(MIL_CONST_TEXTA_PTR FileName,
                           MIL_ID SystemId,
                           MIL_INT64  ControlFlag,
                           MIL_ID *ContextOrResultIdPtr);

MIL_REG_DLLFUNC void MFTYPE MregSaveA(MIL_CONST_TEXTA_PTR FileName,
                      MIL_ID ContextOrResultId,
                      MIL_INT64  ControlFlag);

MIL_REG_DLLFUNC void MFTYPE MregStreamA(MIL_TEXTA_PTR MemPtrOrFileName,
                        MIL_ID SysId,
                        MIL_INT64  Operation,
                        MIL_INT64  StreamType,
                        MIL_DOUBLE Version,
...
MIL_REG_DLLFUNC MIL_ID MFTYPE MregRestore(MIL_CONST_TEXT_PTR FileName,
                          MIL_ID SystemId,
                          MIL_INT64  ControlFlag,
                          MIL_ID *ContextOrResultIdPtr);

MIL_REG_DLLFUNC void MFTYPE MregSave(MIL_CONST_TEXT_PTR FileName,
                     MIL_ID ContextOrResultId,
                     MIL_INT64  ControlFlag);

MIL_REG_DLLFUNC void MFTYPE MregStream(MIL_TEXT_PTR MemPtrOrFileName,
                       MIL_ID SysId,
                       MIL_INT64  Operation,
                       MIL_INT64  StreamType,
                       MIL_DOUBLE Version,
...
#if M_MIL_USE_64BIT
// Prototypes for 64 bits OSs
MIL_REG_DLLFUNC void MFTYPE MregSetLocationInt64(MIL_ID     ContextId,
                                 MIL_INT    Index,
                                 MIL_INT    Target,
                                 MIL_INT64  ParamType,
                                 MIL_INT64  Param1,
...
MIL_REG_DLLFUNC void MFTYPE MregSetLocationDouble(MIL_ID     ContextId,
                                  MIL_INT    Index,
                                  MIL_INT    Target,
                                  MIL_INT64  ParamType,
                                  MIL_DOUBLE Param1,
...
MIL_REG_DLLFUNC void MFTYPE MregSetLocation(MIL_ID     ContextId,
                            MIL_INT    Index,
                            MIL_INT    Target,
                            MIL_INT64  ParamType,
                            MIL_DOUBLE Param1,
...
MIL_REG_DLLFUNC void MFTYPE MregTransformImage(MIL_ID RegResultId,
                               const MIL_ID *ImageArrayPtr,
...
MIL_REG_DLLFUNC void MFTYPE MregTransformCoordinate(MIL_ID     RegResultId,
                                    MIL_INT    Source,
                                    MIL_INT    Destination,
                                    MIL_DOUBLE X,
                                    MIL_DOUBLE Y,
...
MIL_REG_DLLFUNC void MFTYPE MregTransformCoordinateList(MIL_ID            RegResultId,
                                        MIL_INT           Source,
                                        MIL_INT           Destination,
                                        MIL_INT           NumPoints,
...
inline void MFTYPE MregGetResultSafeType(MIL_ID RegResultId, MIL_INT ResultIndex, MIL_INT64  ResultType, std::nullptr_t             );
#endif
...
#if M_MIL_SAFE_TYPE_M_NULL_PTR_TYPE_EXISTS
inline MIL_INT MFTYPE MregInquireSafeType(MIL_ID ContextOrResultId, MIL_INT Index, MIL_INT64  InquireType, std::nullptr_t         );
#endif
...
inline void MregCalculate(MIL_ID ContextId, MilConstArrayIdParam ImageArrayPtr, MIL_ID RegResultOrImageId, MIL_INT NumImages, MIL_INT64  ControlFlag)
   {
   MregCalculate(ContextId, ImageArrayPtr.m_IdArrayPtr, RegResultOrImageId, NumImages, ControlFlag);
   }
...
inline void MregTransformImage(MIL_ID RegResultId, MilConstArrayIdParam ImageArrayPtr, MIL_ID DestImageBufId, MIL_INT NumImages, MIL_INT64 InterpolationMode, MIL_INT64 ControlFlag)
   {
   MregTransformImage(RegResultId, ImageArrayPtr.m_IdArrayPtr, DestImageBufId, NumImages, InterpolationMode, ControlFlag);
   }
