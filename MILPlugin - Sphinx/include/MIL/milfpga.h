...
/************************************************************************/
MIL_DLLFUNC MIL_INT MFTYPE MfpgaCommandAlloc(  MIL_ID MilSysId,
...
MIL_DLLFUNC MIL_INT MFTYPE MfpgaCommandFree(   MIL_FPGA_CONTEXT FpgaCommandContext,
                                               MIL_INT64 ControlFlag);

#if M_MIL_USE_UNICODE

MIL_DLLFUNC MIL_INT MFTYPE MfpgaLoadA(         MIL_ID MilSystemId,
                                               MIL_INT FpgaDeviceNumber,
                                               MIL_CONST_TEXTA_PTR FirmwareFile,
                                               MIL_INT64 ControlFlag);

MIL_DLLFUNC MIL_INT MFTYPE MfpgaLoadW(         MIL_ID MilSystemId,
                                               MIL_INT FpgaDeviceNumber,
...
MIL_DLLFUNC MIL_INT MFTYPE MfpgaLoad(          MIL_ID MilSystemId,
                                               MIL_INT FpgaDeviceNumber,
...
MIL_DLLFUNC void MFTYPE MfpgaSetSource(        MIL_FPGA_CONTEXT FpgaCommandContext,
                                               MIL_BUFFER_INFO SrcBuf,
                                               MIL_INT StreamInputNumber,
                                               MIL_INT64 ControlFlag);

MIL_DLLFUNC MIL_INT MFTYPE MfpgaSetDestination(MIL_FPGA_CONTEXT FpgaCommandContext,
                                               MIL_BUFFER_INFO DstBuf,
                                               MIL_INT StreamOutputNumber,
                                               MIL_INT64 ControlFlag);

MIL_DLLFUNC MIL_INT MFTYPE MfpgaSetLink(       MIL_FPGA_CONTEXT SrcFpgaCommandContext,
                                               MIL_INT SrcStreamPort,
                                               MIL_FPGA_CONTEXT DstFpgaCommandContext,
                                               MIL_INT DstStreamPort,
                                               MIL_INT64 ControlFlag);

MIL_DLLFUNC void MFTYPE MfpgaCommandQueue(     MIL_FPGA_CONTEXT FpgaCommandContext,
                                               MIL_INT64 CompletionMode,
                                               MIL_INT64 QueueType);

MIL_DLLFUNC void MFTYPE MfpgaGetRegister(      MIL_FPGA_CONTEXT FpgaCommandContext,
...
MIL_DLLFUNC void MFTYPE MfpgaSetRegister(      MIL_FPGA_CONTEXT FpgaCommandContext,
                                               MIL_INT64 RegisterSection,
                                               MIL_INT Offset,
                                               MIL_INT Length,
                                               void *ValuePtr,
...
MIL_DLLFUNC void MFTYPE MfpgaGetAndSetRegister(MIL_FPGA_CONTEXT FpgaCommandContext,
...
MIL_DLLFUNC void MFTYPE MfpgaCommandControl(   MIL_FPGA_CONTEXT FpgaCommandContext,
                                               MIL_INT64 ControlType,
                                               const void *ControlValuePtr);

MIL_DLLFUNC void MFTYPE MfpgaCommandInquire(   MIL_FPGA_CONTEXT FpgaCommandContext,
                                               MIL_INT64 InquireType,
                                               void *UserVarPtr);

MIL_DLLFUNC MIL_INT MFTYPE MfpgaInquire(       MIL_ID MilSystemId,
                                               MIL_INT FpgaDeviceNumber,
                                               MIL_INT64 InquireType,
                                               void* UserVarPtr);

MIL_DLLFUNC MIL_INT MFTYPE MfpgaControl(       MIL_ID MilSystemId,
                                               MIL_INT FpgaDeviceNumber,
                                               MIL_INT64 ControlType,
                                               const void* ControlValuePtr);

MIL_DLLFUNC void MFTYPE MfpgaHookFunction(     MIL_ID MilSystemId,
                                               MIL_INT DeviceNumber,
                                               MIL_INT FunctionId,
                                               MIL_INT SubFunctionId,
                                               MIL_INT64 FunctionNumber,
...
MIL_DLLFUNC MIL_INT MFTYPE MfpgaGetHookInfo(   MIL_ID EventId,
                                               MIL_INT64 InfoType,
                                               void *UserVarPtr);
