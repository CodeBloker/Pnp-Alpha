...
#define M_ERR_2_SUBMSG_2         MIL_TEXT("Cannot force AVX512 on a non-AVX512 CPU or the OS does not support AVX512.")
...
#define M_ERR_107_SUBMSG_3       MIL_TEXT("Object type doesn't match file extension.")
...
#define M_ERR_128_SUBMSG_6       MIL_TEXT("+M_SUPPORTED, +M_AVAILABLE, +M_IS_SET_TO_DEFAULT or +M_DEFAULT cannot be used with this operation.")
...
#define M_ERR_136_SUBMSG_4       MIL_TEXT("Cannot allocate compensated object.")
#define M_ERR_136_SUBMSG_5       MIL_TEXT("Cannot sync the compensated object.")
...
#define M_ERR_167_SUBMSG_4       MIL_TEXT("GenTL producer number must be between 0 and M_GENTL_PRODUCER_COUNT.")
...
#define M_ERR_171_SUBMSG_3       MIL_TEXT("Error while reading file.")
#define M_ERR_171_SUBMSG_4       MIL_TEXT("Unknown file extension.")
#define M_ERR_171_SUBMSG_5       MIL_TEXT("Path is invalid.")
...
#define M_ERR_184_SUBMSG_3       MIL_TEXT("Error allocating a child.")
#define M_ERR_184_SUBMSG_4       MIL_TEXT("Invalid number of criteria.")
...
#define M_ERR_197_SUBMSG_4       MIL_TEXT("This system type is no longer supported.")
...
#define M_ERR_199_SUBMSG_5       MIL_TEXT("Bad parameter value (number of entries).")
#define M_ERR_199_SUBMSG_6       MIL_TEXT("The container is not M_PROC.")
#define M_ERR_199_SUBMSG_7       MIL_TEXT("The container is not M_DISP.")
#define M_ERR_199_SUBMSG_8       MIL_TEXT("The container is not M_GRAB.")
#define M_ERR_199_SUBMSG_9       MIL_TEXT("Invalid control flag for the operation.")
...
#define M_ERR_200_SUBMSG_2       MIL_TEXT("Cannot load stream in provided buffer.")
#define M_ERR_200_SUBMSG_3       MIL_TEXT("Buffer component type must be M_COMPONENT_DISPARITY.")
#define M_ERR_200_SUBMSG_4       MIL_TEXT("Buffer component type must be M_COMPONENT_RANGE or M_COMPONENT_DISPARITY.")
#define M_ERR_200_SUBMSG_5       MIL_TEXT("Host address cannot fit in a 32 bits value.")
#define M_ERR_200_SUBMSG_6       MIL_TEXT("Target buffer already linked.")
#define M_ERR_200_SUBMSG_7       MIL_TEXT("Target buffer was not linked.")
#define M_ERR_200_SUBMSG_8       MIL_TEXT("When using M_COMPENSATE, the target buffer must be M_PROC and/or M_DISP.")
#define M_ERR_200_SUBMSG_9       MIL_TEXT("The buffer cannot be a child.")
...
#define M_ERR_203_SUBMSG_2       MIL_TEXT("Invalid criteria.")
#define M_ERR_203_SUBMSG_3       MIL_TEXT("Cannot allocate a component in a child container.")
#define M_ERR_203_SUBMSG_4       MIL_TEXT("Cannot free a component on a child container.")
#define M_ERR_203_SUBMSG_5       MIL_TEXT("Source and destination must both be containers.")
#define M_ERR_203_SUBMSG_6       MIL_TEXT("Operation only works on container.")
#define M_ERR_203_SUBMSG_7       MIL_TEXT("Child container cannot be a destination.")
#define M_ERR_203_SUBMSG_8       MIL_TEXT("Fail to create component.")
#define M_ERR_203_SUBMSG_9       MIL_TEXT("Operation not permitted on a child container.")
...
#define M_ERR_205_MSG            MIL_TEXT("Invalid parameter.")
#define M_ERR_205_SUBMSG_1       MIL_TEXT("Control value cannot be zero.")
#define M_ERR_205_SUBMSG_2       MIL_TEXT("Control value must be greater than zero.")
#define M_ERR_205_SUBMSG_3       MIL_TEXT("Control value must be in [0.0 : 10.0].")
#define M_ERR_205_SUBMSG_4       MIL_TEXT("Operation cannot be done on a source container.")
#define M_ERR_205_SUBMSG_5       MIL_TEXT("Operation cannot be done on a source buffer.")
#define M_ERR_205_SUBMSG_6       MIL_TEXT("Invalid component.")
#define M_ERR_205_SUBMSG_7       MIL_TEXT("All the buffers must be a container.")
#define M_ERR_205_SUBMSG_8       MIL_TEXT("Source and destination must be on the same system.")
#define M_ERR_205_SUBMSG_9       MIL_TEXT("Invalid control flag for the requested operation.")

#define M_GENDC_ERROR            56206L
#define M_ERR_206_MSG            MIL_TEXT("GenDC error.")
#define M_ERR_206_SUBMSG_1       MIL_TEXT("Part type unsupported.")
#define M_ERR_206_SUBMSG_2       MIL_TEXT("H264 Part type unsupported.")
#define M_ERR_206_SUBMSG_3       MIL_TEXT("Cannot allocate component.")
#define M_ERR_206_SUBMSG_4       MIL_TEXT("Invalid GenDC stream.")
#define M_ERR_206_SUBMSG_5       MIL_TEXT("Multispectral not supported.")
#define M_ERR_206_SUBMSG_6       MIL_TEXT("Component not supported by MIL.")
#define M_ERR_206_SUBMSG_7       MIL_TEXT("Unsupported number of parts.")
#define M_ERR_206_SUBMSG_8       MIL_TEXT("JPEG part not supported.")
#define M_ERR_206_SUBMSG_9       MIL_TEXT("Cannot save an empty container.")

#define M_OPERATION_ERROR_13     56207L
#define M_ERR_207_MSG            MIL_TEXT("Operation error.")
#define M_ERR_207_SUBMSG_1       MIL_TEXT("File's object type must be compatible with the buffer.")
#define M_ERR_207_SUBMSG_2       MIL_TEXT("Operation is not supported with a line thickness greater than 1.")
#define M_ERR_207_SUBMSG_3       MIL_TEXT("Source and destination container component count are different.")
...
#define M_CONTAINER_ERROR_3      56208L
#define M_ERR_208_MSG            MIL_TEXT("Container error.")
#define M_ERR_208_SUBMSG_1       MIL_TEXT("Cannot allocate component.")
#define M_ERR_208_SUBMSG_2       MIL_TEXT("One of the component cannot be freed.")
#define M_ERR_208_SUBMSG_3       MIL_TEXT("Cannot append the buffer in the container.")
#define M_ERR_208_SUBMSG_4       MIL_TEXT("Component Time Stamp not supported on a container.")
...
#define M_GENDC_ERROR_2          56209L
#define M_ERR_209_MSG            MIL_TEXT("GenDC error.")
#define M_ERR_209_SUBMSG_1       MIL_TEXT("Component object type not supported for saving.")
#define M_ERR_209_SUBMSG_2       MIL_TEXT("Unsupported component type.")
#define M_ERR_209_SUBMSG_3       MIL_TEXT("Group ID is out of range.")
#define M_ERR_209_SUBMSG_4       MIL_TEXT("Source ID is out of range.")
#define M_ERR_209_SUBMSG_5       MIL_TEXT("Region ID is out of range.")
#define M_ERR_209_SUBMSG_6       MIL_TEXT("Region offset is out of range.")
#define M_ERR_209_SUBMSG_7       NO_SUBMSG
#define M_ERR_209_SUBMSG_8       NO_SUBMSG
#define M_ERR_209_SUBMSG_9       NO_SUBMSG

#define M_INVALID_PARAM_ERROR_47 56210L
#define M_ERR_210_MSG            MIL_TEXT("Invalid parameter.")
#define M_ERR_210_SUBMSG_1       MIL_TEXT("Cannot use +M_IS_SET_TO_DEFAULT at the same time as +M_AVAILABLE, +M_SUPPORTED or +M_DEFAULT.")
...
#define M_DATA_AUGMENT_ERROR_2   56211L
#define M_ERR_211_MSG            MIL_TEXT("Invalid parameter.")
#define M_ERR_211_SUBMSG_1       MIL_TEXT("Source size must be greater than or equal to 3 with a Deriche smooth or sharpen operation.")
#define M_ERR_211_SUBMSG_2       MIL_TEXT("SeedValue should be set to M_DEFAULT in this mode.")
