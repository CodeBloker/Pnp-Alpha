...
#if M_MIL_USE_RT
#ifdef M_OCR_EXPORTS
#define MIL_OCR_DLLFUNC __declspec(dllexport)
#else
#define MIL_OCR_DLLFUNC __declspec(dllimport)
#endif
#else
#define MIL_OCR_DLLFUNC
#endif
/* Prototypes              */
...
MIL_OCR_DLLFUNC MIL_ID  MFTYPE MocrAllocFont(    MIL_ID     SystemId,
                                 MIL_INT64  FontType,
                                 MIL_INT    CharNumber,
...
MIL_OCR_DLLFUNC MIL_ID  MFTYPE MocrAllocResult(  MIL_ID     SystemId,
                                 MIL_INT64  InitFlag,
                                 MIL_ID*    ResultOcrIdPtr);

MIL_OCR_DLLFUNC void    MFTYPE MocrFree(         MIL_ID     FontContextOrResultOcrId);

MIL_OCR_DLLFUNC void    MFTYPE MocrGetResult(    MIL_ID     ResultOcrId,
                                 MIL_INT64  ResultType,
                                 void      *ResultPtr);

MIL_OCR_DLLFUNC MIL_INT    MFTYPE MocrInquire(   MIL_ID     FontContextOrResultOcrId,
                                 MIL_INT64  InquireType,
                                 void       *UserVarPtr);

MIL_OCR_DLLFUNC void    MFTYPE MocrReadString(   MIL_ID ImageBufId,
                                 MIL_ID FontContextOcrId,
                                 MIL_ID OcrResultId);

MIL_OCR_DLLFUNC void    MFTYPE MocrModifyFont(   MIL_ID      FontContextOcrId,
                                 MIL_INT64   Operation,
                                 MIL_INT64   OperationFlag);

#if M_MIL_USE_64BIT
// Prototypes for 64 bits OSs
MIL_OCR_DLLFUNC void    MFTYPE MocrControlInt64 (MIL_ID      FontContextOrResultOcrId,
                                 MIL_INT64   ControlType,
                                 MIL_INT64   ControlValue);

MIL_OCR_DLLFUNC void    MFTYPE MocrControlDouble(MIL_ID     FontContextOrResultOcrId,
                                 MIL_INT64  ControlType,
...
MIL_OCR_DLLFUNC void    MFTYPE MocrControl( MIL_ID     FontContextOrResultOcrId,
                            MIL_INT64  ControlType,
                            MIL_DOUBLE ControlValue);
#endif

MIL_OCR_DLLFUNC void    MFTYPE MocrLineControl(  MIL_ID     FontId,
                                 MIL_INT    LineIndex,
                                 MIL_INT64  ControlToSet,
                                 double     Value);


MIL_OCR_DLLFUNC MIL_OCR_HOOK_FUNCTION_PTR MFTYPE MocrHookFunction( MIL_ID  FontContextOcrId,
                                                   MIL_INT HookType,
                                                   MIL_OCR_HOOK_FUNCTION_PTR HookHandlerPtr,
                                                   void   *UserDataPtr);

MIL_OCR_DLLFUNC MIL_INT MFTYPE OcrSemiM1292CheckValid(MIL_INT HookType,
                                      char *String,
                                      void *FExpansionFlagPtr);
MIL_OCR_DLLFUNC MIL_INT MFTYPE OcrSemiM1388CheckValid(MIL_INT HookType,
                                      char *String,
                                      void *FExpansionFlagPtr);
MIL_OCR_DLLFUNC MIL_INT MFTYPE OcrSemiCheckValid(   MIL_INT HookType,
                                     char *String,
                                     void *FExpansionFlagPtr);
MIL_OCR_DLLFUNC MIL_INT MFTYPE OcrDefaultCheckValid(MIL_INT HookType,
                                    char *String,
                                    void *FExpansionFlagPtr);

MIL_OCR_DLLFUNC MIL_ID MFTYPE MocrAutoAllocFont( MIL_ID SystemId,
                                 MIL_ID ImageId,
                                 MIL_INT    CharNumber,
                                 MIL_INT    StringLength,
                                 MIL_INT64  InitFlag,
...
MIL_OCR_DLLFUNC void MFTYPE MocrPreprocess(MIL_ID FontContextOcrId, MIL_INT64 ControlFlag);

#if M_MIL_USE_UNICODE

MIL_OCR_DLLFUNC void     MFTYPE MocrCalibrateFontW(MIL_ID             ImageBufId,
                                   MIL_ID             FontContextOcrId,
...
MIL_OCR_DLLFUNC void     MFTYPE MocrCopyFontW(MIL_ID ImageBufId,
                              MIL_ID FontContextOcrId,
                              MIL_INT64 Operation,
                              MIL_CONST_TEXTW_PTR CharListString);

MIL_OCR_DLLFUNC void     MFTYPE MocrImportFontW(MIL_CONST_TEXTW_PTR FileName,
                                MIL_INT64  FileFormat,
                                MIL_INT64  Operation,
                                MIL_CONST_TEXTW_PTR CharListString,
                                MIL_ID FontContextOcrId);

MIL_OCR_DLLFUNC MIL_ID   MFTYPE MocrRestoreFontW(MIL_CONST_TEXTW_PTR FileName,
                                 MIL_INT64  Operation,
                                 MIL_ID SystemId,
                                 MIL_ID *FontContextOcrIdPtr);

MIL_OCR_DLLFUNC void     MFTYPE MocrSaveFontW(MIL_CONST_TEXTW_PTR FileName,
                              MIL_INT64  Operation,
                              MIL_ID FontContextOcrId);

MIL_OCR_DLLFUNC void     MFTYPE MocrSetConstraintW(MIL_ID FontContextOcrId,
                                   MIL_INT CharPos,
                                   MIL_INT64  CharPosType,
                                   MIL_CONST_TEXTW_PTR CharValidString);

MIL_OCR_DLLFUNC void     MFTYPE MocrLineSetConstraintW(MIL_ID FontId,
                                       MIL_INT LineIndex,
                                       MIL_INT CharPos,
                                       MIL_INT64  CharPosType,
                                       MIL_CONST_TEXTW_PTR CharValid);

MIL_OCR_DLLFUNC void     MFTYPE MocrStreamW(MIL_TEXTW_PTR MemPtrOrFileName    ,
                            MIL_ID       SysId            ,
                            MIL_INT64    Operation           ,
...
MIL_OCR_DLLFUNC void     MFTYPE MocrVerifyStringW(MIL_ID ImageBufId,
                                  MIL_ID FontContextOcrId,
                                  MIL_CONST_TEXTW_PTR String,
                                  MIL_ID OcrResultId);

MIL_OCR_DLLFUNC MIL_INT64 MFTYPE MocrValidateStringW(MIL_ID FontId,
                                     MIL_INT64  Mode,
                                     MIL_CONST_TEXTW_PTR String);

MIL_OCR_DLLFUNC void     MFTYPE MocrDrawW(MIL_ID         ContextGraId,
...
MIL_OCR_DLLFUNC void     MFTYPE MocrCalibrateFontA(MIL_ID      ImageBufId,
                                   MIL_ID      FontContextOcrId,
...
MIL_OCR_DLLFUNC void     MFTYPE MocrCopyFontA(MIL_ID ImageBufId,
                              MIL_ID FontContextOcrId,
                              MIL_INT64  Operation,
                              MIL_CONST_TEXTA_PTR CharListString);

MIL_OCR_DLLFUNC void     MFTYPE MocrImportFontA(MIL_CONST_TEXTA_PTR FileName,
                                MIL_INT64  FileFormat,
                                MIL_INT64  Operation,
                                MIL_CONST_TEXTA_PTR CharListString,
                                MIL_ID FontContextOcrId);

MIL_OCR_DLLFUNC MIL_ID   MFTYPE MocrRestoreFontA(MIL_CONST_TEXTA_PTR FileName,
                                 MIL_INT64  Operation,
                                 MIL_ID SystemId,
                                 MIL_ID *FontContextOcrIdPtr);

MIL_OCR_DLLFUNC void     MFTYPE MocrSaveFontA(MIL_CONST_TEXTA_PTR FileName,
                              MIL_INT64  Operation,
                              MIL_ID FontContextOcrId);

MIL_OCR_DLLFUNC void     MFTYPE MocrSetConstraintA(MIL_ID FontContextOcrId,
                                   MIL_INT CharPos,
                                   MIL_INT64  CharPosType,
                                   MIL_CONST_TEXTA_PTR CharValidString);

MIL_OCR_DLLFUNC void     MFTYPE MocrLineSetConstraintA(MIL_ID FontId,
                                       MIL_INT LineIndex,
                                       MIL_INT CharPos,
                                       MIL_INT64  CharPosType,
                                       MIL_CONST_TEXTA_PTR CharValid);

MIL_OCR_DLLFUNC void     MFTYPE MocrStreamA(MIL_TEXTA_PTR        MemPtrOrFileName    ,
                            MIL_ID       SysId            ,
                            MIL_INT64    Operation           ,
                            MIL_INT64    StreamType          ,
                            MIL_DOUBLE   Version             ,
...
MIL_OCR_DLLFUNC void     MFTYPE MocrVerifyStringA(MIL_ID ImageBufId,
                                  MIL_ID FontContextOcrId,
                                  MIL_CONST_TEXTA_PTR String,
                                  MIL_ID OcrResultId);

MIL_OCR_DLLFUNC MIL_INT64 MFTYPE MocrValidateStringA(MIL_ID FontId,
                                     MIL_INT64  Mode,
                                     MIL_CONST_TEXTA_PTR String);

MIL_OCR_DLLFUNC void     MFTYPE MocrDrawA(MIL_ID         ContextGraId,
                          MIL_ID         FontContextOrResultOcrId,
                          MIL_ID         DstImageBufOrListGraId,
                          MIL_INT64      Operation,
                          MIL_INT        Index,
...
MIL_OCR_DLLFUNC void    MFTYPE MocrCalibrateFont(MIL_ID             ImageBufId,
                                 MIL_ID             FontContextOcrId,
...
MIL_OCR_DLLFUNC void    MFTYPE MocrCopyFont(MIL_ID ImageBufId,
                            MIL_ID FontContextOcrId,
                            MIL_INT64  Operation,
                            MIL_CONST_TEXT_PTR CharListString);

MIL_OCR_DLLFUNC void    MFTYPE MocrImportFont(MIL_CONST_TEXT_PTR FileName,
                              MIL_INT64  FileFormat,
                              MIL_INT64  Operation,
                              MIL_CONST_TEXT_PTR CharListString,
                              MIL_ID FontContextOcrId);

MIL_OCR_DLLFUNC MIL_ID  MFTYPE MocrRestoreFont(MIL_CONST_TEXT_PTR FileName,
                               MIL_INT64  Operation,
                               MIL_ID SystemId,
                               MIL_ID *FontContextOcrIdPtr);

MIL_OCR_DLLFUNC void    MFTYPE MocrSaveFont(MIL_CONST_TEXT_PTR FileName,
                            MIL_INT64  Operation,
                            MIL_ID FontContextOcrId);

MIL_OCR_DLLFUNC void    MFTYPE MocrSetConstraint(MIL_ID FontContextOcrId,
                                 MIL_INT CharPos,
                                 MIL_INT64  CharPosType,
                                 MIL_CONST_TEXT_PTR CharValidString);

MIL_OCR_DLLFUNC void    MFTYPE MocrLineSetConstraint(MIL_ID FontId,
                                     MIL_INT LineIndex,
                                     MIL_INT CharPos,
                                     MIL_INT64  CharPosType,
                                     MIL_CONST_TEXT_PTR CharValid);

MIL_OCR_DLLFUNC void MFTYPE MocrStream(MIL_TEXT_PTR MemPtrOrFileName    ,
                       MIL_ID       SysId            ,
                       MIL_INT64    Operation           ,
                       MIL_INT64    StreamType          ,
                       MIL_DOUBLE   Version             ,
...
MIL_OCR_DLLFUNC void    MFTYPE MocrVerifyString( MIL_ID ImageBufId,
                                 MIL_ID FontContextOcrId,
                                 MIL_CONST_TEXT_PTR String,
                                 MIL_ID OcrResultId);
...
MIL_OCR_DLLFUNC void     MFTYPE MocrDraw(MIL_ID         ContextGraId,
                         MIL_ID         FontContextOrResultOcrId,
                         MIL_ID         DstImageBufOrListGraId,
                         MIL_INT64      Operation,
                         MIL_INT        Index,
...
inline MIL_INT MFTYPE MocrInquireSafeType(MIL_ID ContextId, MIL_INT64  InquireType, std::nullptr_t            );
#endif
...
#if M_MIL_SAFE_TYPE_M_NULL_PTR_TYPE_EXISTS
inline void MFTYPE MocrGetResultSafeType(MIL_ID OcrResultId, MIL_INT64  ResultType, std::nullptr_t                );
#endif
...
inline MIL_INT64  MocrInquireRequiredType(MIL_INT64  InquireType)
   ...
   if((InquireType & M_CONSTRAINT) == M_CONSTRAINT)
      {
      if(M_STRING_SIZE_BIT_SET(InquireType))
...
inline MIL_ID MFTYPE MocrRestoreFontW(const MIL_STRING& FileName, MIL_INT64 Operation, MIL_ID SystemId, MIL_ID *FontContextOcrIdPtr)
   {
   return MocrRestoreFontW(FileName.c_str(), Operation, SystemId, FontContextOcrIdPtr);
   }
...
inline MIL_ID MFTYPE MocrRestoreFontA(const MIL_STRING& FileName, MIL_INT64 Operation, MIL_ID SystemId, MIL_ID *FontContextOcrIdPtr)
   {
   return MocrRestoreFontA(FileName.c_str(), Operation, SystemId, FontContextOcrIdPtr);
   }
...
inline MIL_ID MFTYPE MocrRestoreFont(const MIL_STRING& FileName, MIL_INT64 Operation, MIL_ID SystemId, MIL_ID *FontContextOcrIdPtr)
   {
   return MocrRestoreFont(FileName.c_str(), Operation, SystemId, FontContextOcrIdPtr);
   }
...
inline MIL_INT MFTYPE MocrInquireSafeType(MIL_ID ContextId, MIL_INT64 InquireType, MIL_STRING &ValuePtr)
   ...
   if(InternalStringSize > 0)
      ...
      RetValue = MocrInquireExecute(ContextId, (InquireType & (~M_HLVLDATATYPE_MASK)) + M_TYPE_TEXT_CHAR, &ValuePtr[0], M_TYPE_TEXT_CHAR);
...
inline void MFTYPE MocrGetResultSafeType(MIL_ID OcrResultId, MIL_INT64 ResultType, MIL_STRING &ValuePtr)
   ...
   if(InternalStringSize > 0)
      ...
      ValuePtr.assign(InternalStringSize, MIL_TEXT('\0'));
#if M_MIL_UNICODE_API
      MocrGetResultExecute(OcrResultId, (ResultType & (~M_HLVLDATATYPE_MASK)) + M_TYPE_TEXT_CHAR, &ValuePtr[0], M_TYPE_TEXT_CHAR);
#else
      MocrGetResultExecute(OcrResultId, (ResultType & (~M_HLVLDATATYPE_MASK)), &ValuePtr[0], M_TYPE_TEXT_CHAR);
#endif
      ValuePtr.resize(InternalStringSize - 1);
...
inline MIL_UNIQUE_OCR_ID MocrAllocResult(MIL_ID SystemId, MIL_INT64 InitFlag, MIL_UNIQUE_ID_TAG)
   {
   return MIL_UNIQUE_OCR_ID(MocrAllocResult(SystemId, InitFlag, M_NULL));
   }
inline MIL_UNIQUE_OCR_ID MocrRestoreFont(MIL_CONST_TEXT_PTR FileName, MIL_INT64 Operation, MIL_ID SystemId, MIL_UNIQUE_ID_TAG)
   {
   return MIL_UNIQUE_OCR_ID(MocrRestoreFont(FileName, Operation, SystemId, M_NULL));
   }
#if M_MIL_USE_STRING
inline MIL_UNIQUE_OCR_ID MocrRestoreFont(const MIL_STRING& FileName, MIL_INT64 Operation, MIL_ID SystemId, MIL_UNIQUE_ID_TAG)
   {
   return MIL_UNIQUE_OCR_ID(MocrRestoreFont(FileName, Operation, SystemId, M_NULL));
   }
#endif // M_MIL_USE_STRING
