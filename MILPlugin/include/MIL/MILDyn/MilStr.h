...
#if M_MIL_USE_RT
#ifdef M_STR_EXPORTS
#define MIL_STR_DLLFUNC __declspec(dllexport)
#else
#define MIL_STR_DLLFUNC __declspec(dllimport)
#endif
#else
#define MIL_STR_DLLFUNC
#endif
...
MIL_STR_DLLFUNC MIL_ID MFTYPE MstrAlloc         (MIL_ID      SystemId,
                                 MIL_INT64   ContextType,
                                 MIL_INT64   ControlFlag,
                                 MIL_ID*     ObjectIdPtr);

MIL_STR_DLLFUNC MIL_ID MFTYPE MstrAllocResult   (MIL_ID      SystemId,
                                 MIL_INT64   ControlFlag,
                                 MIL_ID*     ObjectIdPtr);

MIL_STR_DLLFUNC void MFTYPE MstrFree            (MIL_ID      ObjectId);

#if M_MIL_USE_64BIT
// Prototypes for 64 bits OSs
MIL_STR_DLLFUNC void MFTYPE MstrControlInt64    (MIL_ID      ContextOrResultId,
                                 MIL_INT     Index,
                                 MIL_INT64   ControlType,
                                 MIL_INT64   ControlValue);

MIL_STR_DLLFUNC void MFTYPE MstrControlDouble   (MIL_ID      ContextOrResultId,
                                 MIL_INT     Index,
                                 MIL_INT64   ControlType,
...
MIL_STR_DLLFUNC void MFTYPE MstrControl         (MIL_ID      ContextOrResultId,
                                 MIL_INT     Index,
                                 MIL_INT64   ControlType,
                                 MIL_DOUBLE  ControlValue);
...
MIL_STR_DLLFUNC MIL_INT MFTYPE MstrInquire      (MIL_ID      ContextOrResultId,
                                 MIL_INT     Index,
                                 MIL_INT64   InquireType,
                                 void*       UserVarPtr);

MIL_STR_DLLFUNC void MFTYPE MstrEditFont        (MIL_ID   ContextId,
                                 MIL_INT     FontIndex,
                                 MIL_INT64   Operation,
...
MIL_STR_DLLFUNC void MFTYPE MstrSetConstraint   (MIL_ID   ContextId,
                                 MIL_INT     StringIndex,
                                 MIL_INT     CharPos,
                                 MIL_INT64   ConstraintType,
                                 const void*    CharListPtr);

MIL_STR_DLLFUNC void MFTYPE MstrPreprocess      (MIL_ID      ContextId,
                                 MIL_INT64   ControlFlag);

MIL_STR_DLLFUNC void MFTYPE MstrRead            (MIL_ID      ContextId,
                                 MIL_ID      TargetImageId,
                                 MIL_ID      ResultId);

MIL_STR_DLLFUNC void MFTYPE MstrGetResult       (MIL_ID      ResultId,
                                 MIL_INT     Index,
                                 MIL_INT64   ResultType,
                                 void*       ResultArrayPtr);

MIL_STR_DLLFUNC void MFTYPE MstrDraw            (MIL_ID   ContextGraId,
...
MIL_STR_DLLFUNC void MFTYPE MstrExpert          (MIL_ID         ContextId,
...
MIL_STR_DLLFUNC MIL_ID MFTYPE MstrTrain(         MIL_ID               TrainingBaseId,
...
MIL_STR_DLLFUNC void MFTYPE MstrHookTrainFunction(MIL_ID                          ContextId,
                                  MIL_STR_HOOK_TRAIN_FUNCTION_PTR HookHandlerPtr,
                                  void*                           UserDataPtr);

MIL_STR_DLLFUNC MIL_ID MFTYPE MstrGenerateTrainingSet(MIL_ID*    ContextIdArrayPtr,
                                      MIL_INT    ArraySize,
                                      MIL_ID     DatabaseId,
                                      MIL_INT64  ControlFlag);
...
MIL_STR_DLLFUNC void MFTYPE MstrSaveA            (MIL_CONST_TEXTA_PTR   FileName,
                                  MIL_ID  ContextId,
                                  MIL_INT64  ControlFlag);

MIL_STR_DLLFUNC MIL_ID MFTYPE MstrRestoreA       (MIL_CONST_TEXTA_PTR FileName,
                                  MIL_ID      SystemId,
                                  MIL_INT64   ControlFlag,
                                  MIL_ID*     ContextIdPtr);

MIL_STR_DLLFUNC void MFTYPE MstrStreamA          (MIL_TEXTA_PTR         MemPtrOrFileName,
                                  MIL_ID        SysId,
                                  MIL_INT64     Operation,
...
MIL_STR_DLLFUNC void MFTYPE MstrSaveW            (MIL_CONST_TEXTW_PTR  FileName,
                                  MIL_ID        ContextId,
                                  MIL_INT64     ControlFlag);

MIL_STR_DLLFUNC MIL_ID MFTYPE MstrRestoreW       (MIL_CONST_TEXTW_PTR  FileName,
                                  MIL_ID        SystemId,
                                  MIL_INT64     ControlFlag,
                                  MIL_ID*       ContextIdPtr);

MIL_STR_DLLFUNC void MFTYPE MstrStreamW          (MIL_TEXTW_PTR  MemPtrOrFileName,
                                  MIL_ID        SysId,
                                  MIL_INT64     Operation,
                                  MIL_INT64     StreamType,
                                  MIL_DOUBLE    Version,
...
MIL_STR_DLLFUNC void MFTYPE MstrSave            (MIL_CONST_TEXT_PTR  FileName,
                                 MIL_ID        ContextId,
                                 MIL_INT64     ControlFlag);

MIL_STR_DLLFUNC MIL_ID MFTYPE MstrRestore       (MIL_CONST_TEXT_PTR  FileName,
                                 MIL_ID        SystemId,
                                 MIL_INT64     ControlFlag,
                                 MIL_ID*       ContextIdPtr);

MIL_STR_DLLFUNC void MFTYPE MstrStream          (MIL_TEXT_PTR  MemPtrOrFileName,
                                 MIL_ID        SysId,
                                 MIL_INT64     Operation,
                                 MIL_INT64     StreamType,
                                 MIL_DOUBLE    Version,
...
inline MIL_INT MFTYPE MstrInquireSafeType(MIL_ID ContextId, MIL_INT Index, MIL_INT64  InquireType, std::nullptr_t            );
#endif
...
#if M_MIL_SAFE_TYPE_M_NULL_PTR_TYPE_EXISTS
inline void MFTYPE MstrGetResultSafeType(MIL_ID ResultId, MIL_INT Index, MIL_INT64  ResultType, std::nullptr_t                );
#endif
...
inline MIL_INT64  MstrInquireRequiredType(MIL_ID ContextId, MIL_INT64  InquireType)
   {
   MIL_INT Encoding;
   // Special case required for M_CONSTRAINT since an index may have been added 
   // to the Inquire type (M_CONSTRAINT + 3 as an example)
   MIL_INT64 TheType = InquireType;
   if ((InquireType & ~M_CONSTRAINT_INDEX_MASK) == M_CONSTRAINT)
      TheType = M_CONSTRAINT;
...
inline MIL_ID MFTYPE MstrRestoreW(const MIL_STRING& FileName, MIL_ID SystemId, MIL_INT64 ControlFlag, MIL_ID* ContextIdPtr)
   {
   return MstrRestoreW(FileName.c_str(), SystemId, ControlFlag, ContextIdPtr);
   }
...
inline MIL_ID MFTYPE MstrRestoreA(const MIL_STRING& FileName, MIL_ID SystemId, MIL_INT64 ControlFlag, MIL_ID* ContextIdPtr)
   {
   return MstrRestoreA(FileName.c_str(), SystemId, ControlFlag, ContextIdPtr);
   }
...
inline MIL_ID MFTYPE MstrRestore(const MIL_STRING& FileName, MIL_ID SystemId, MIL_INT64 ControlFlag, MIL_ID* ContextIdPtr)
   {
   return MstrRestore(FileName.c_str(), SystemId, ControlFlag, ContextIdPtr);
   }
...
#if M_MIL_UNICODE_API
      RetValue = MstrInquireExecute(ContextId, Index, (InquireType & (~M_HLVLDATATYPE_MASK)) + M_TYPE_TEXT_CHAR, &ValuePtr[0], M_TYPE_TEXT_CHAR);
#else
      RetValue = MstrInquireExecute(ContextId, Index, (InquireType & (~M_HLVLDATATYPE_MASK)), &ValuePtr[0], M_TYPE_TEXT_CHAR);
#endif
...
inline void MFTYPE MstrGetResultSafeType(MIL_ID ResultId, MIL_INT Index, MIL_INT64  ResultType, MIL_STRING   &ValuePtr)
   ...
   if(InternalFlagIndicatingToDoMilStringOperations)
      ...
      if(InternalStringSize > 0)
         ...
         ValuePtr.assign(InternalStringSize, MIL_TEXT('\0'));
#if M_MIL_UNICODE_API
         MstrGetResultExecute(ResultId, Index, (ResultType & (~M_HLVLDATATYPE_MASK)) + M_TYPE_TEXT_CHAR, &ValuePtr[0], M_TYPE_TEXT_CHAR);
#else
         MstrGetResultExecute(ResultId, Index, (ResultType & (~M_HLVLDATATYPE_MASK)), &ValuePtr[0], M_TYPE_TEXT_CHAR);
#endif
         ValuePtr.resize(InternalStringSize - 1);
...
inline MIL_UNIQUE_STR_ID MstrAlloc(MIL_ID SystemId, MIL_INT64 ContextType, MIL_INT64 ControlFlag, MIL_UNIQUE_ID_TAG)
   {
   return MIL_UNIQUE_STR_ID(MstrAlloc(SystemId, ContextType, ControlFlag, M_NULL));
   }
inline MIL_UNIQUE_STR_ID MstrAllocResult(MIL_ID SystemId, MIL_INT64 ControlFlag, MIL_UNIQUE_ID_TAG)
   {
   return MIL_UNIQUE_STR_ID(MstrAllocResult(SystemId, ControlFlag, M_NULL));
   }
inline MIL_UNIQUE_STR_ID MstrRestore(MIL_CONST_TEXT_PTR FileName, MIL_ID SystemId, MIL_INT64 ControlFlag, MIL_UNIQUE_ID_TAG)
   {
   return MIL_UNIQUE_STR_ID(MstrRestore(FileName, SystemId, ControlFlag, M_NULL));
   }
#if M_MIL_USE_STRING
inline MIL_UNIQUE_STR_ID MstrRestore(const MIL_STRING& FileName, MIL_ID SystemId, MIL_INT64 ControlFlag, MIL_UNIQUE_ID_TAG)
   {
   return MIL_UNIQUE_STR_ID(MstrRestore(FileName, SystemId, ControlFlag, M_NULL));
   }
#endif // M_MIL_USE_STRING
