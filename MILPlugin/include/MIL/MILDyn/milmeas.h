...
#if M_MIL_USE_RT
#ifdef M_MEAS_EXPORTS
#define MIL_MEAS_DLLFUNC __declspec(dllexport)
#else
#define MIL_MEAS_DLLFUNC __declspec(dllimport)
#endif
#else
#define MIL_MEAS_DLLFUNC
#endif
...
MIL_MEAS_DLLFUNC MIL_ID MFTYPE MmeasAllocMarker  (MIL_ID     SystemId,
                                 MIL_INT64  MarkerType,
                                 MIL_INT64  ControlFlag,
                                 MIL_ID*    MarkerIdPtr);

MIL_MEAS_DLLFUNC MIL_ID MFTYPE MmeasAllocResult  (MIL_ID     SystemId,
                                 MIL_INT64  ResultType,
                                 MIL_ID*    MeasResultIdPtr);

MIL_MEAS_DLLFUNC MIL_ID MFTYPE MmeasAllocContext (MIL_ID     SystemId,
                                 MIL_INT64  ControlFlag,
                                 MIL_ID*    ContextIdPtr);

MIL_MEAS_DLLFUNC void   MFTYPE MmeasFree (MIL_ID MeasId);

MIL_MEAS_DLLFUNC void   MFTYPE MmeasSetMarker (MIL_ID     MarkerId,
                                               MIL_INT64  CharacteristicToSet,
                                               MIL_DOUBLE FirstValue,
                                               MIL_DOUBLE SecondValue);

MIL_MEAS_DLLFUNC void MFTYPE MmeasSetScore (MIL_ID     MarkerId,
...
MIL_MEAS_DLLFUNC void MFTYPE MmeasGetScore(MIL_ID      MarkerId,
                                           MIL_INT64   Characteristic,
                                           MIL_INT     Index,
...
MIL_MEAS_DLLFUNC void MFTYPE MmeasGetScoreOutputUnits(MIL_ID      MarkerId,
                                     MIL_INT64   Characteristic,
                                     MIL_INT     Index,
...
MIL_MEAS_DLLFUNC void   MFTYPE MmeasFindMarker(MIL_ID     ContextId,
                                               MIL_ID     ImageBufId,
                                               MIL_ID     MarkerId,
                                               MIL_INT64  MeasurementList);


MIL_MEAS_DLLFUNC void   MFTYPE MmeasCalculate(MIL_ID     ContextId,
                                              MIL_ID     Marker1Id,
                                              MIL_ID     Marker2Id,
                                              MIL_ID     MeasResultId,
                                              MIL_INT64  MeasurementList);

MIL_MEAS_DLLFUNC void   MFTYPE MmeasGetResult(MIL_ID      MarkerOrMeasResultId,
                                              MIL_INT64   ResultType,
                                              void*       FirstResultArrayPtr,
                                              void*       SecondResultArrayPtr);

MIL_MEAS_DLLFUNC void   MFTYPE MmeasGetResultOutputUnits(MIL_ID      MarkerOrResultId,
                                                         MIL_INT64   ResultType,
                                                         MIL_INT64   OutputUnits,
                                                         void*       FirstResultPtr,
                                                         void*       SecondResultPtr);

MIL_MEAS_DLLFUNC void MFTYPE MmeasGetResultSingle(MIL_ID    MarkerOrMeasResultId,
                                                  MIL_INT64 ResultType,
                                                  void*     FirstResultArrayPtr,
                                                  void*     SecondResultArrayPtr,
                                                  MIL_INT   ResultIndex);

MIL_MEAS_DLLFUNC void MFTYPE MmeasGetResultSingleOutputUnits(MIL_ID    MarkerOrResultId,
                                                             MIL_INT64 ResultType,
                                                             MIL_INT64 OutputUnits,
                                                             void*     FirstResultPtr,
                                                             void*     SecondResultPtr,
...
MIL_MEAS_DLLFUNC MIL_INT MFTYPE MmeasInquire(MIL_ID     MeasId,
...
MIL_MEAS_DLLFUNC void   MFTYPE MmeasControlInt64(MIL_ID     ContextOrResultId,
                                                 MIL_INT64  ControlType,
                                                 MIL_INT64  ControlValue);

MIL_MEAS_DLLFUNC void   MFTYPE MmeasControlDouble(MIL_ID     ContextOrResultId,
                                                  MIL_INT64  ControlType,
                                                  MIL_DOUBLE ControlValue);

MIL_MEAS_DLLFUNC void   MFTYPE MmeasSetMarkerDouble(MIL_ID     MarkerId,
                                                    MIL_INT64  CharacteristicToSet,
                                                    MIL_DOUBLE FirstValue,
                                                    MIL_DOUBLE SecondValue);

MIL_MEAS_DLLFUNC void   MFTYPE MmeasSetMarkerInt64(MIL_ID    MarkerId,
                                                   MIL_INT64 CharacteristicToSet,
...
MIL_MEAS_DLLFUNC void   MFTYPE MmeasControl(MIL_ID     ContextOrResultId,
                                            MIL_INT64  ControlType,
                                            MIL_DOUBLE ControlValue);
#endif

MIL_MEAS_DLLFUNC void MFTYPE MmeasDraw(MIL_ID     ContextGraId,
...
MIL_MEAS_DLLFUNC void   MFTYPE MmeasSaveMarkerW  (MIL_CONST_TEXTW_PTR FileName,
                                 MIL_ID             MarkerId,
                                 MIL_INT64          ControlFlag);

MIL_MEAS_DLLFUNC MIL_ID MFTYPE MmeasRestoreMarkerW(MIL_CONST_TEXTW_PTR FileName,
                                  MIL_ID             SystemId,
                                  MIL_INT64          ControlFlag,
                                  MIL_ID*            MarkerIdPtr);

MIL_MEAS_DLLFUNC void MFTYPE MmeasStreamW        (MIL_TEXTW_PTR MemPtrOrFileName,
                                 MIL_ID       SysId,
                                 MIL_INT64    Operation,
...
MIL_MEAS_DLLFUNC void   MFTYPE MmeasSaveMarkerA  (MIL_CONST_TEXTA_PTR  FileName,
                                 MIL_ID       MarkerId,
                                 MIL_INT64    ControlFlag);

MIL_MEAS_DLLFUNC MIL_ID MFTYPE MmeasRestoreMarkerA(MIL_CONST_TEXTA_PTR FileName,
                                  MIL_ID      SystemId,
                                  MIL_INT64   ControlFlag,
                                  MIL_ID*     MarkerIdPtr);

MIL_MEAS_DLLFUNC void MFTYPE MmeasStreamA        (MIL_TEXTA_PTR        MemPtrOrFileName,
                                 MIL_ID       SysId,
                                 MIL_INT64    Operation,
                                 MIL_INT64    StreamType,
                                 MIL_DOUBLE   Version,
...
MIL_MEAS_DLLFUNC void   MFTYPE MmeasSaveMarker   (MIL_CONST_TEXT_PTR FileName,
                                 MIL_ID             MarkerId,
                                 MIL_INT64          ControlFlag);

MIL_MEAS_DLLFUNC MIL_ID MFTYPE MmeasRestoreMarker(MIL_CONST_TEXT_PTR FileName,
                                 MIL_ID             SystemId,
                                 MIL_INT64          ControlFlag,
                                 MIL_ID*            MarkerIdPtr);

MIL_MEAS_DLLFUNC void MFTYPE MmeasStream         (MIL_TEXT_PTR MemPtrOrFileName,
                                 MIL_ID       SysId,
                                 MIL_INT64    Operation,
                                 MIL_INT64    StreamType,
                                 MIL_DOUBLE   Version,
...
inline void MFTYPE MmeasGetResultSafeType(MIL_ID MarkerOrMeasResultId, MIL_INT64  ResultType, MIL_INT32      *FirstResultArrayPtr, std::nullptr_t                      );
inline void MFTYPE MmeasGetResultSafeType(MIL_ID MarkerOrMeasResultId, MIL_INT64  ResultType, MIL_INT64      *FirstResultArrayPtr, std::nullptr_t                      );
inline void MFTYPE MmeasGetResultSafeType(MIL_ID MarkerOrMeasResultId, MIL_INT64  ResultType, MIL_DOUBLE     *FirstResultArrayPtr, std::nullptr_t                      );
inline void MFTYPE MmeasGetResultSafeType(MIL_ID MarkerOrMeasResultId, MIL_INT64  ResultType, std::nullptr_t                     , std::nullptr_t                      );
#endif
...
#if M_MIL_SAFE_TYPE_M_NULL_PTR_TYPE_EXISTS
inline void MFTYPE MmeasGetResultSafeType(MIL_ID MarkerOrMeasResultId, MIL_INT64  ResultType, MIL_UINT32     *FirstResultArrayPtr, std::nullptr_t                      );
inline void MFTYPE MmeasGetResultSafeType(MIL_ID MarkerOrMeasResultId, MIL_INT64  ResultType, MIL_UINT64     *FirstResultArrayPtr, std::nullptr_t                      );
#endif
...
#if M_MIL_SAFE_TYPE_M_NULL_PTR_TYPE_EXISTS
inline void MFTYPE MmeasGetResultSingleSafeType(MIL_ID MarkerOrMeasResultId, MIL_INT64  ResultType, MIL_INT32      *FirstResultArrayPtr,std::nullptr_t                       , MIL_INT ResultIndex);
inline void MFTYPE MmeasGetResultSingleSafeType(MIL_ID MarkerOrMeasResultId, MIL_INT64  ResultType, MIL_INT64      *FirstResultArrayPtr,std::nullptr_t                       , MIL_INT ResultIndex);
inline void MFTYPE MmeasGetResultSingleSafeType(MIL_ID MarkerOrMeasResultId, MIL_INT64  ResultType, MIL_DOUBLE     *FirstResultArrayPtr,std::nullptr_t                       , MIL_INT ResultIndex);
inline void MFTYPE MmeasGetResultSingleSafeType(MIL_ID MarkerOrMeasResultId, MIL_INT64  ResultType, std::nullptr_t                     ,std::nullptr_t                       , MIL_INT ResultIndex);
#endif
...
#if M_MIL_SAFE_TYPE_M_NULL_PTR_TYPE_EXISTS
inline void MFTYPE MmeasGetResultSingleSafeType(MIL_ID MarkerOrMeasResultId, MIL_INT64  ResultType, MIL_UINT32     *FirstResultArrayPtr, std::nullptr_t                      , MIL_INT ResultIndex);
inline void MFTYPE MmeasGetResultSingleSafeType(MIL_ID MarkerOrMeasResultId, MIL_INT64  ResultType, MIL_UINT64     *FirstResultArrayPtr, std::nullptr_t                      , MIL_INT ResultIndex);
#endif
...
#if M_MIL_SAFE_TYPE_M_NULL_PTR_TYPE_EXISTS
inline MIL_INT MFTYPE MmeasInquireSafeType(MIL_ID MeasId, MIL_INT64  InquireType, std::nullptr_t                   , std::nullptr_t                    );
#endif
...
#if M_MIL_SAFE_TYPE_M_NULL_PTR_TYPE_EXISTS
inline void MmeasGetResultSafeTypeExecute(MIL_ID MarkerOrMeasResultId, MIL_INT64  ResultType, void* FirstResultArrayPtr, std::nullptr_t, MIL_INT64  FirstGivenType)
   {
   MIL_INT64  RequiredType = (ResultType & M_HLVLDATATYPE_MASK);
   if((RequiredType != M_TYPE_DOUBLE) && (RequiredType != M_TYPE_MIL_INT32) && (RequiredType != M_TYPE_MIL_INT64))
      RequiredType = 0;
   ...
   if(RequiredType != FirstGivenType)
      SafeTypeError(MIL_TEXT("MmeasGetResult"));
...
#if M_MIL_SAFE_TYPE_M_NULL_PTR_TYPE_EXISTS
inline void MFTYPE MmeasGetResultSafeType(MIL_ID MarkerOrMeasResultId, MIL_INT64  ResultType, MIL_INT32   *FirstResultArrayPtr, std::nullptr_t                   ){MmeasGetResultSafeTypeExecute(MarkerOrMeasResultId, ResultType, FirstResultArrayPtr, M_NULL              , M_TYPE_MIL_INT32); }
inline void MFTYPE MmeasGetResultSafeType(MIL_ID MarkerOrMeasResultId, MIL_INT64  ResultType, MIL_INT64   *FirstResultArrayPtr, std::nullptr_t                   ){MmeasGetResultSafeTypeExecute(MarkerOrMeasResultId, ResultType, FirstResultArrayPtr, M_NULL              , M_TYPE_MIL_INT64); }
inline void MFTYPE MmeasGetResultSafeType(MIL_ID MarkerOrMeasResultId, MIL_INT64  ResultType, MIL_DOUBLE  *FirstResultArrayPtr, std::nullptr_t                   ){MmeasGetResultSafeTypeExecute(MarkerOrMeasResultId, ResultType, FirstResultArrayPtr, M_NULL              , M_TYPE_DOUBLE); }
#endif
...
#if M_MIL_SAFE_TYPE_M_NULL_PTR_TYPE_EXISTS
inline void MFTYPE MmeasGetResultSafeType(MIL_ID MarkerOrMeasResultId, MIL_INT64  ResultType, MIL_UINT32  *FirstResultArrayPtr, std::nullptr_t                   ){MmeasGetResultSafeTypeExecute(MarkerOrMeasResultId, ResultType, FirstResultArrayPtr, M_NULL              , M_TYPE_MIL_INT32); }
inline void MFTYPE MmeasGetResultSafeType(MIL_ID MarkerOrMeasResultId, MIL_INT64  ResultType, MIL_UINT64  *FirstResultArrayPtr, std::nullptr_t                   ){MmeasGetResultSafeTypeExecute(MarkerOrMeasResultId, ResultType, FirstResultArrayPtr, M_NULL              , M_TYPE_MIL_INT64); }
#endif
...
#if M_MIL_SAFE_TYPE_M_NULL_PTR_TYPE_EXISTS
inline void MmeasGetResultSingleSafeTypeExecute(MIL_ID MarkerOrMeasResultId, MIL_INT64  ResultType, void* FirstResultArrayPtr, std::nullptr_t, MIL_INT ResultIndex, MIL_INT64  FirstGivenType)
   {
   MIL_INT64  RequiredType = (ResultType & M_HLVLDATATYPE_MASK);
   if((RequiredType != M_TYPE_DOUBLE) && (RequiredType != M_TYPE_MIL_INT32) && (RequiredType != M_TYPE_MIL_INT64))
      RequiredType = 0;
...
#if M_MIL_SAFE_TYPE_M_NULL_PTR_TYPE_EXISTS
inline void MFTYPE MmeasGetResultSingleSafeType(MIL_ID MarkerOrMeasResultId, MIL_INT64  ResultType, MIL_INT32   *FirstResultArrayPtr, std::nullptr_t                   , MIL_INT ResultIndex){MmeasGetResultSingleSafeTypeExecute(MarkerOrMeasResultId, ResultType, FirstResultArrayPtr, M_NULL              , ResultIndex, M_TYPE_MIL_INT32);}
inline void MFTYPE MmeasGetResultSingleSafeType(MIL_ID MarkerOrMeasResultId, MIL_INT64  ResultType, MIL_INT64   *FirstResultArrayPtr, std::nullptr_t                   , MIL_INT ResultIndex){MmeasGetResultSingleSafeTypeExecute(MarkerOrMeasResultId, ResultType, FirstResultArrayPtr, M_NULL              , ResultIndex, M_TYPE_MIL_INT64);}
inline void MFTYPE MmeasGetResultSingleSafeType(MIL_ID MarkerOrMeasResultId, MIL_INT64  ResultType, MIL_DOUBLE  *FirstResultArrayPtr, std::nullptr_t                   , MIL_INT ResultIndex){MmeasGetResultSingleSafeTypeExecute(MarkerOrMeasResultId, ResultType, FirstResultArrayPtr, M_NULL              , ResultIndex, M_TYPE_DOUBLE   );}
#endif
...
#if M_MIL_SAFE_TYPE_M_NULL_PTR_TYPE_EXISTS
inline void MFTYPE MmeasGetResultSingleSafeType(MIL_ID MarkerOrMeasResultId, MIL_INT64  ResultType, MIL_UINT32  *FirstResultArrayPtr, std::nullptr_t                   , MIL_INT ResultIndex){MmeasGetResultSingleSafeTypeExecute(MarkerOrMeasResultId, ResultType, FirstResultArrayPtr, M_NULL              , ResultIndex, M_TYPE_MIL_INT32);}
inline void MFTYPE MmeasGetResultSingleSafeType(MIL_ID MarkerOrMeasResultId, MIL_INT64  ResultType, MIL_UINT64  *FirstResultArrayPtr, std::nullptr_t                   , MIL_INT ResultIndex){MmeasGetResultSingleSafeTypeExecute(MarkerOrMeasResultId, ResultType, FirstResultArrayPtr, M_NULL              , ResultIndex, M_TYPE_MIL_INT64);}
#endif
...
inline MIL_ID MFTYPE MmeasRestoreMarkerW(const MIL_STRING& FileName, MIL_ID SystemId, MIL_INT64 ControlFlag, MIL_ID* MarkerIdPtr)
   {
   return MmeasRestoreMarkerW(FileName.c_str(), SystemId, ControlFlag, MarkerIdPtr);
   }
...
inline MIL_ID MFTYPE MmeasRestoreMarkerA(const MIL_STRING& FileName, MIL_ID SystemId, MIL_INT64 ControlFlag, MIL_ID* MarkerIdPtr)
   {
   return MmeasRestoreMarkerA(FileName.c_str(), SystemId, ControlFlag, MarkerIdPtr);
   }
...
inline MIL_ID MFTYPE MmeasRestoreMarker(const MIL_STRING& FileName, MIL_ID SystemId, MIL_INT64 ControlFlag, MIL_ID* MarkerIdPtr)
   {
   return MmeasRestoreMarker(FileName.c_str(), SystemId, ControlFlag, MarkerIdPtr);
   }
...
inline MIL_UNIQUE_MEAS_ID MmeasAllocMarker(MIL_ID SystemId, MIL_INT64 MarkerType, MIL_INT64 ControlFlag, MIL_UNIQUE_ID_TAG)
   {
   return MIL_UNIQUE_MEAS_ID(MmeasAllocMarker(SystemId, MarkerType, ControlFlag, M_NULL));
   }
inline MIL_UNIQUE_MEAS_ID MmeasAllocContext(MIL_ID SystemId, MIL_INT64 ControlFlag, MIL_UNIQUE_ID_TAG)
   {
   return MIL_UNIQUE_MEAS_ID(MmeasAllocContext(SystemId, ControlFlag, M_NULL));
   }
inline MIL_UNIQUE_MEAS_ID MmeasAllocResult(MIL_ID SystemId, MIL_INT64 ResultType, MIL_UNIQUE_ID_TAG)
   {
   return MIL_UNIQUE_MEAS_ID(MmeasAllocResult(SystemId, ResultType, M_NULL));
   }
inline MIL_UNIQUE_MEAS_ID MmeasRestoreMarker(MIL_CONST_TEXT_PTR FileName, MIL_ID SystemId, MIL_INT64 ControlFlag, MIL_UNIQUE_ID_TAG)
   {
   return MIL_UNIQUE_MEAS_ID(MmeasRestoreMarker(FileName, SystemId, ControlFlag, M_NULL));
   }
#if M_MIL_USE_STRING
inline MIL_UNIQUE_MEAS_ID MmeasRestoreMarker(const MIL_STRING& FileName, MIL_ID SystemId, MIL_INT64 ControlFlag, MIL_UNIQUE_ID_TAG)
   {
   return MIL_UNIQUE_MEAS_ID(MmeasRestoreMarker(FileName, SystemId, ControlFlag, M_NULL));
   }
#endif // M_MIL_USE_STRING
