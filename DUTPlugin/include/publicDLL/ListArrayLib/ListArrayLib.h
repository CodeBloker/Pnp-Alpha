...
DLLAPI void* STDCALL MallocArrayPointListVector();

DLLAPI void STDCALL AddArrayPoint(ArrayPoint* PointArray, CvPoint Point);

DLLAPI void STDCALL AddArrayPointList(ArrayListPointVector* PointArrayList, ListPoint PointList);
...
DLLAPI void STDCALL FreeArrayListPointVector(ArrayListPointVector *pointSetVector);
