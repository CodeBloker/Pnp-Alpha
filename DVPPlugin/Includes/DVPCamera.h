...
*
*@section 当前API
* @version Version 2.25.43.1341(build: May 25 2023 15:03:35)
*
*
*@section 文档发布记录
...
*@subsection Ver16 2022-2-18(2.25.43)
...
*@param[in] handle 设备句柄
*@param[in] strKey 属性键值，如获取像素格式信息则为“PixelFormat”
*@param[in] uEnumValue 当前枚举值
*@param[out] strEnumName 当前枚举值对应的名字
*/
...
*@brief 获取属性类型
*@param[in] handle 设备句柄
*@param[out] strKey 属性名
*@param[out] pEnInterfaceType 接口类型
*/
